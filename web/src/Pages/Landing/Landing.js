...
function Landing() {
    ...
    return (
        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <p className="py-6">Solve programming problems, do homework and compile your code there! Project is open-source btw, you can contribute if you want to (designers&frontenders pls help)</p>
        ...
        {isVisible && code !== 200 ? (
                <div
                    role="alert"
                    className="alert alert-error fixed bottom-0 right-0 mb-4 mr-4 md:w-1/2 w-full z-50 animate-fade-in-out"
                >
                    <svg
